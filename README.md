...
[Case study](https://aigalaxy.top/blog/design-learn-ui-rules) · [AgentsGalaxy](https://aigalaxy.top/) · [Chrome + MCP workflow](https://github.com/GalaxyXieyu/Design-Learn)
...
1. Load `chrome-extension/` as an unpacked Chrome extension.
2. Click the extension on a page you want to study.
3. Optionally start `design-learn-server` if you want local persistence, MCP, or VSCode integration.
